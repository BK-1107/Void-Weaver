...
- **🎨 隐性色彩提取 (Hidden Palette Extraction)**：自动从原图中提取 5-7 种主色调作为“隐藏标签”，确保生成结果的色彩与原图完美契合，且不干扰 UI 界面。
- **🔍 智能八维分析**：使用 Google Gemini 系列最新模型将图片解构为 8 个核心模块（画风、主体、姿势、服装、背景、构图、氛围、额外细节）。
...
- **Google Gemini/Vertex API** (REST 集成)
- **OkHttp** (NovelAI 与 Google 集成)
- **Lombok** / **Jackson**
